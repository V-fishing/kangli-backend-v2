...
CREATE TABLE qms.finished_goods_inspection (
    is_urgent TEXT, qc_review TEXT, mgr_approval TEXT, is_valid TEXT, inspection_result TEXT,
    report_no TEXT, inspection_request_no TEXT, production_order_no TEXT, material_code TEXT,
    product_name TEXT, model_spec TEXT, prod_batch_or_sn TEXT, production_date TEXT,
    expiry_date TEXT, submitted_qty TEXT, inspected_qty TEXT, qualified_qty TEXT,
    unqualified_qty TEXT, unit TEXT, inspector_name TEXT, category TEXT, qc_reviewer TEXT,
    qc_review_time TEXT, mgr_representative TEXT, mgr_approval_time TEXT, is_entrusted TEXT,
    drug_reg_no TEXT, perf_test_method TEXT, perf_sample_batch_no TEXT, signature_user TEXT,
    signature_time TEXT, signature_reason TEXT, plant_code TEXT, plant_name TEXT,
    created_by TEXT, updated_by TEXT, is_deleted TEXT, "version" TEXT, created_at TEXT,
    updated_at TEXT
);

DROP TABLE IF EXISTS qms.critical_material_binding;
CREATE TABLE qms.critical_material_binding (
    category TEXT, work_order_no TEXT, product_barcode TEXT, product_material_no TEXT,
    product_name TEXT, work_order_qty TEXT, material_barcode TEXT, material_code TEXT,
    material_name TEXT, spec_model TEXT, scanner TEXT, scan_time TEXT, process_code TEXT,
    process_name TEXT, is_active TEXT, deactivate_operator TEXT, deactivate_time TEXT,
    remark TEXT, plant_code TEXT, plant_name TEXT, created_by TEXT, updated_by TEXT,
